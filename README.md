...
Copy the file [sample/WarehouseRepository.java](Main/Java/src/main/solution/com/dci/java/data/WarehouseRepository.java) into `com.dci.java.data` package in your project.
...
#   w a r e h o u s e - p r o j e c t - I o a n n i s - L a v e n t z a k i s - m a i n  
 